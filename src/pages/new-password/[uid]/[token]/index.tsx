...
const NewPasswordPage: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      {/* Image Section */}
      <div className="hidden md:flex md:w-8/12 relative bg-cover bg-center"
      ...
      <div className="w-full md:w-4/12 flex items-center justify-center p-6">
        <div className="w-full bg-white shadow-2xl rounded-2xl p-10 sm:p-12 relative">
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            Remember your password? <a href="/" className="font-medium text-indigo-600 hover:text-indigo-500">Sign in</a>
          </p>
